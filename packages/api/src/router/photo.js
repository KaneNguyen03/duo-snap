...
function extensionFrom(fileName, contentType) {
    var _a, _b;
    var fromFile = (_a = fileName.split(".").pop()) === null || _a === void 0 ? void 0 : _a.toLowerCase().replace(/[^a-z0-9]/g, "");
    if (fromFile)
        return fromFile;
    var fromType = (_b = contentType.split("/").at(1)) === null || _b === void 0 ? void 0 : _b.replace(/[^a-z0-9]/g, "");
    return fromType || "jpg";
}
...
exports.photoRouter = {
    list: trpc_1.protectedProcedure.query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, ctx.db.query.photos.findMany({
                        with: {
                            profile: true,
                        },
                ...
                case 1:
                    rows = _c.sent();
                    return [2 /*return*/, Promise.all(rows.map(function (photo) { return __awaiter(void 0, void 0, void 0, function () {
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                    ...
                                    case 1: return [2 /*return*/, (_a.imageUrl = _b.sent(),
                                            _a.author = {
                                                id: photo.profile.id,
                    ...
                    try {
                        ...
                        if (error instanceof auth_1.MissingSupabaseConfigError) {
                            throw new server_1.TRPCError({
                                ...
                                message: "Missing SUPABASE_SERVICE_ROLE_KEY. It is required on the server to create signed upload URLs.",
                            });
                        }
                        throw error;
                    }
                    extension = extensionFrom(input.fileName, input.contentType);
                    path = "".concat(ctx.user.id, "/").concat(Date.now(), "-").concat((0, node_crypto_1.randomUUID)(), ".").concat(extension);
                    return [4 /*yield*/, supabase.storage
                            .from(auth_1.SNAP_BUCKET)
    ...
    create: trpc_1.protectedProcedure.input(schema_1.CreatePhotoSchema).mutation(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var photo;
        var _c;
        var ctx = _b.ctx, input = _b.input;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ctx.db
                            ...
                            caption: ((_c = input.caption) === null || _c === void 0 ? void 0 : _c.trim()) || null,
                        })
                            .returning()];
                case 1:
                    photo = (_d.sent())[0];
    ...
    delete: trpc_1.protectedProcedure.input(v4_1.z.object({ id: v4_1.z.string().uuid() })).mutation(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var photo;
        var ctx = _b.ctx, input = _b.input;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    photo = (_c.sent())[0];
                    return [2 /*return*/, photo !== null && photo !== void 0 ? photo : null];
            }
        });
    }); }),
};
