    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                if (t._config.isDev) {
                    console.log("[TRPC] ".concat(path, " took ").concat(end - start, "ms"));
                }
...
exports.protectedProcedure = t.procedure
    ...
    .use(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var database;
        ...
        switch (_c.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, next({
                        ctx: __assign(__assign({}, ctx), { db: database, user: ctx.user }),
                    })];
        }
    });
}); });
